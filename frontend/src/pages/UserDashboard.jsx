...
export default function UserDashboard() {
    ...
    const { user, regions, alerts, recent_alerts, channels, global: globalStats } = data
            ...
            <VStack spacing={6} align="stretch">
                ...
                >
                    ...
                    <Grid templateColumns="repeat(4, 1fr)" gap={4}>
                        <VStack align="flex-start" spacing={0}>
                            <Text fontSize="2xl" fontWeight="800" color="brand.400">
                                {globalStats.earthquakes_24h}
                            </Text>
                            <Text fontSize="xs" color="gray.500">Earthquakes (24h)</Text>
                            <Text fontSize="2xs" color="gray.600">M2.5+, worldwide</Text>
                        </VStack>
                        <VStack align="flex-start" spacing={0}>
                            <Text fontSize="2xl" fontWeight="800" color="brand.400">
                                {globalStats.earthquakes_7d}
                            </Text>
                            <Text fontSize="xs" color="gray.500">Earthquakes (7d)</Text>
                            <Text fontSize="2xs" color="gray.600">M2.5+, worldwide</Text>
                        </VStack>
                        <VStack align="flex-start" spacing={0}>
                            <Text fontSize="2xl" fontWeight="800"
                                color={globalStats.significant_7d > 0 ? 'orange.400' : 'gray.400'}>
                                {globalStats.significant_7d}
                            </Text>
                            <Text fontSize="xs" color="gray.500">Significant (7d)</Text>
                            <Text fontSize="2xs" color="gray.600">M5.0+, worldwide</Text>
                        </VStack>
                        <VStack align="flex-start" spacing={0}>
                            <Text fontSize="2xl" fontWeight="800"
                                color={globalStats.major_7d > 0 ? 'red.400' : 'gray.400'}>
                                {globalStats.major_7d}
                            </Text>
                            <Text fontSize="xs" color="gray.500">Major (7d)</Text>
                            <Text fontSize="2xs" color="gray.600">M6.0+, worldwide</Text>
                        </VStack>
                    </Grid>
                </Box>
